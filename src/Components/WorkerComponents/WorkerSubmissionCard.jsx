...
const WorkerSubmissionCard = ({ item, refetch }) => {
  const {
    _id,
    task_id,
    task_title,
  ...
  <td className="text-[10px] px-2 md:px-0 text-red-700 md:text-xs">
    <span className="px-2 py-1 rounded-xl bg-red-100 ">{status}</span>
  </td>
)}
    </tr>
  );
...
export default WorkerSubmissionCard;
